...
class Ui_MainWindow(object):
    def __init__(self):
        self.filters = Filters(False,0,0,0,0)
    ...
    def setupUi(self, MainWindow):
        ...
        #apply changes
        self.apply_changes_button.clicked.connect(self.applyFilters)
    ...
    def setTriangulation(self, triangulate):
        self.filters.triangulate = triangulate    
    
    def setFrameRate(self, frame_rate):
        self.filters.frame_rate = frame_rate

    def setHue(self, hue):
        self.filters.hue = hue

    def setSaturation(self, saturation):
        self.filters.saturation = saturation

    def setBrightness(self, brightness):
        self.filters.brightness = brightness
        self.process.brightness = self.filters.brightness

    def applyFilters(self):
        print(self.filters.triangulate)
        print(self.filters.frame_rate)
        print(self.filters.hue)
        print(self.filters.saturation)
        print(self.filters.brightness)
        self.process.brightness = self.filters.brightness
    ...
    def playVideo(self):
        ...
        if self.filename != None:
            ...
            while(vid.isOpened()):
                ...
                ret, frame = vid.read()
                if ret:
                     #10 = time of each frame in ms
                    img = self.process.changeBrightness(frame)
